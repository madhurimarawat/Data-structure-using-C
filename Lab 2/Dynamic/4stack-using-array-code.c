...
void size(int n){
//printf("The size of stack is:%d",sizeof(arr));}
...
if(e==(n+1)){nsize+=1;;}else if(e==(-1)){break;} 
else if(e==(n-1)){nsize-=1;}else{nsize=n;}}
else{
free(arr); }}
return 0; }